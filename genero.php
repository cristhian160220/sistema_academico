...
<div class="x_content">
<table id="example" class="table table-striped table-bordered"><thead><tr>
<th>Identificador</th>
<th>Cargo</th>
<th>Acciones</th>
</tr></thead><tbody><?php
$b_genero = buscarGenero($conexion);
while ($res_b_genero= mysqli_fetch_array($b_genero)) {?><tr>
<td><?php echo $res_b_genero['id']; ?></td>
<td><?php echo $res_b_genero['genero']; ?></td><td>
<span class="justify-center">
<a href="editar_genero.php?id=<?php echo $res_b_genero['id']; ?>" class="btn btn-primary"><i class="fa fa-edit"> </i> Editar</a>
</td></tr><?php}?></tbody></table></div></div></div></div></div><footer><div class="pull-right">
bienvenido <a href="">cfc</a></div>
